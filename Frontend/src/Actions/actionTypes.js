/*** REGISTER PAGE ***/
export const NEWUSER_PENDING        = 'newuser_pending';
export const NEWUSER_ERROR          = 'newuser_error';
export const NEWUSER_SUCCES         = 'newuser_succes';
...
export const FRIENDS_PENDING    = 'friends_pending';
...
export const COMMENTS_SUBMIT_SUCCESS       = 'comments_submit_success';
...
export const NEWSERVICE_SUCCES      = 'newservice_succes';
